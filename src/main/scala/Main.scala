object Main {
  ...
  /** Funzione che stampa il tempo di esecuzione di block
    ...
    * @param  block
    * @tparam R
    * @return         tempo di esecuzione del blocco
    */
  ...
  /** Stampa il tempo di calcolo
    *
    * @param  time    tempo da convertire in stringa
  ...
  /** Funzione che viene eseguita dal JAR
    *
    * @param  n_places  numero di nodi con i quali si vuole lavorare
    * @param  n_core    numero di unità di calcola che si vogliono utilizzare
    *
